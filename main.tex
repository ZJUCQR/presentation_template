...
\graphicspath{
    {/data/fanliaoyuan/02/video-r1/GenRL/thesis-master/figure/}
    {/data/fanliaoyuan/02/video-r1/GenRL/thesis-master/figure/logo/}
}
  ...
  \vbox{%
    ...
    \hbox{%
      ...
      \begin{beamercolorbox}[wd=.52\paperwidth,ht=2.8ex,dp=1.0ex,center]{normal text}%
        {\fontsize{7.5}{9}\selectfont\color{FootGray}基于视觉语言模型反馈与强化学习优化的世界模型后训练研究}%
      \end{beamercolorbox}%
...
% Metadata
% ============================================================
\title[世界模型后训练研究]{基于视觉语言模型反馈与强化学习优化的\\世界模型后训练研究}
\subtitle{本科毕业论文答辩}
...
\input{sec/0-cover}
\input{sec/1-background}
\input{sec/2-method}
\input{sec/3-experiment}
\input{sec/4-summary}
\input{sec/5-closing}
